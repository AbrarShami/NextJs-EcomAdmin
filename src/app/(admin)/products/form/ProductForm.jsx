                        ...
                        <div className="space-y-6">
                            <div className="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 ">
                                <div className="border-b border-gray-200 px-6 py-4 dark:border-gray-800">
                                    <h2 className="text-lg font-medium text-gray-800 dark:text-white">Products Details</h2>
                                </div>
                                    ...
                                    <form action={action}>
                                        ...
                                        <div className="grid grid-cols-1 gap-5 md:grid-cols-1">
                                            ...
                                            <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                                                ...
                                                <div className="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 ">
                                                    <div className="border-b border-gray-200 px-6 py-4 dark:border-gray-800">
                                                        <h2 className="text-lg font-medium text-gray-800 dark:text-white">Products Image</h2>
                                                    </div>
                                                    <div className="p-4 sm:p-6">
                                                        ...
                                                        >
                                                            ...
                                                            <input id="product-image" ref={fileInputRef} className="hidden" onChange={showName} name="image" type="file"
                                                            />
                                                        </label>
                                                        {state?.errors?.image && (
                                                            Array.isArray(state.errors.image)
                                                                ? state.errors.image.map((error, key) => (
                                                                    <p key={key} className="mt-2 text-sm text-error-500">{error}</p>
                                                                ))
                                                                : <p className="mt-2 text-sm text-error-500">{String(state.errors.image)}</p>
                                                        )}
